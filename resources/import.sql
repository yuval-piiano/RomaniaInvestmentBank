...
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("t3ayy","Antonescu","Iancu",1941118327494,"iancu_antonescu10@yahoo.com","0702060769",2)
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("pgzen","Stoica","Vladimir",5000112356574,"stoicavladimir@yahoo.com","0706683324",3)
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("xkwmp","Gusa","Costache",1950310198829,"costi_gusa5@gmail.com","0702053921",4)
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("7zxt5","Selymes","Skender",1880814359051,"selymes.ske@gmail.com","0780088080",5)
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("3jyfj","Milosovici","Carol",1991224188035,"carolmilosovici@yahoo.com","0702080818",6)
INSERT INTO Client(id, lastName, firstName, cnp, email, phoneNumber, Address_No) values("hpr1g","Tanase","Mihai",1700915136866,"mihai.tanase10@gmail.com","0790528592",7)
